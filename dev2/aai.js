...
(function(window){
  function AAI() {
    var host = 'https://' + window.location.hostname,
        ourEntityID = host.match("dev2-clarin.ilc.cnr.it") ? "https://dev2-clarin.ilc.cnr.it" : host;
    this.defaults = {
//      host : 'https://ufal-point.mff.cuni.cz',
      ...
      responseUrl: window.location.protocol + '//dev2-clarin.ilc.cnr.it/aai/discojuiceDiscoveryResponse.html',
      ourEntityID: ourEntityID + '/Shibboleth.sso/Metadata',
      serviceName: '',
      metadataFeed: host + '/xmlui/discojuice/feeds',
  //    metadataFeed: 'https://dev2-clarin.ilc.cnr.it/repository' + '/xmlui/discojuice/feeds',
